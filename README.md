...
4. Просмотр, добавление, функция отмены или изменения существующего бронирования
5. Просмотр доступных рабочих мест в реальном времени с возможностью фильтрации по дате, времени и типу рабочего места
6. Сохранение бронирований
7. Отправка push-уведомлений о предстоящих бронированиях
8. Просмотр и редактирование настроек уведомлений. 
<br>
